    ...
    ReentrancyGuard
{
    ...
    /// @notice A structure for storing the relationship between Collection Id, Hashes Id, and the Hashes hash used in
    ///         mint. This allows the draw function to work, even after original minter has transfered NFT
    struct idToHash {
        bool exists;
        uint256 hashesId;
        bytes32 hashesHash;
    ...
    ICollectionNFTEligibilityPredicate public override mintEligibilityPredicateContract;
    ...
    ICollectionNFTMintFeePredicate public override mintFeePredicateContract;
    ...
    ICollectionNFTTokenURIPredicate public override TokenURIPredicateContract;
    ...
    function mint(uint256 _hashesTokenId) external payable override initialized nonReentrant {
        ...
        // I tried to pull this data from the URI predicate contracts I made but I couldn't figure out how at the time.

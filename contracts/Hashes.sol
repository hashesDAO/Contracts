...
contract Hashes is IHashes, ERC721Enumerable, ReentrancyGuard, Ownable {
     ...
     */
    function verify(uint256 _tokenId, address _minter, string memory _phrase) external view override returns (bool) {
    ...
    function _moveDelegates(address _initDel, address _finDel, uint256 _amount) internal {
